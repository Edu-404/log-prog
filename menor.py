...
firstOperacion = input('Que tipo de operação deseja com os dois primeiros números: ')
secondOperacion = input('Que tipo de operação deseja com os dois primeiros números: ')
